    ...
    <main className="min-h-screen overflow-hidden">
      ...
      <section id="projects" className="mx-auto max-w-6xl scroll-mt-28 px-5 py-24 lg:px-8">
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {projects.map((project,i)=><motion.article key={project.title} initial={{opacity:0,y:24}} whileInView={{opacity:1,y:0}} viewport={{once:true,amount:.2}} transition={{delay:i*.15}} whileHover={{y:-6}} className="card group flex min-h-[390px] flex-col rounded-3xl p-6 transition-shadow hover:shadow-2xl hover:shadow-black/20">
